...
from common.leetcode_url_generator import get_daily_problem_url


def test_get_daily_problem_url():
    may_28_2021 = datetime.datetime(2021, 5, 28, hour=12, tzinfo=datetime.timezone.utc)
    ...
    may_29_2021 = datetime.datetime(2021, 5, 29, hour=12, tzinfo=datetime.timezone.utc)
    ...
    jan_7_2021 = datetime.datetime(2021, 1, 7, hour=12, tzinfo=datetime.timezone.utc)
