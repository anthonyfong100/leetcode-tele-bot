...
def test_get_daily_problem_url():
    may_28_2021 = datetime.datetime(
        2021, 5, 28, hour=12, tzinfo=datetime.timezone.utc
    )
    ...
    may_29_2021 = datetime.datetime(
        2021, 5, 29, hour=12, tzinfo=datetime.timezone.utc
    )
